            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{route('bulletin.index')}}" class="btn btn-warning btn-elevate btn-icon-sm">
                            <i class="la la-angle-left"></i>
                            @lang('Back Bulletin List')
                        </a>
                    </div>
                </div>
            </div>
        </div>
        <form action="{{route('bulletin.update',['id' => $bulletin->id])}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <div class="kt-portlet__body">
                @include('dashboard.bulletin.form',['formMode' => 'edit'])
            </div>
